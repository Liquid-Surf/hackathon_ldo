  ...
  const welcome =
    <>
      ...
      <p>
        ...
        Therefore, you need a pod to use this app, you can create one here: <a href="https://pod.liquid.surf">pod.liquid.surf</a>
      </p>
      <h3>Usage</h3>
      <p>
        <ol>
          <li>Login with your pod</li>
          <li>Create a tutorial on the "Create" page</li>
          <li>View the list of tutorials on the Home page or "My tutorials" page</li>
          <li>Click on the tutorial preview to see the full tutorial</li>
          <li>You can delete a tutorial by clicking the "Delete" button at the end of a tutorial page</li>
        </ol>
      </p>
    </>
